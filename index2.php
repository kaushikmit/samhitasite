...
<head>
    ...
    <title>Samhita 2k15</title>
	 ...
	 <meta name="robots" content="noindex, nofollow">
        ...
        <link rel="stylesheet" href="http://www.formget.com/tutorial/jquery-popup-form-demo/css/jquery_popup.css">
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><img src="title-tab2.png" width="140" height="40"></a>
            </div>
    ...
    <div class="ws_images"><ul>
        ...
        <li><img src="data2/images/4.jpg" alt="full screen slider" title="full screen slider" id="wows2_3"/></li>
...
<span class="wsl"><a href="http://wowslider.com/vu">image carousel</a> by WOWSlider.com v7.3</span>
    ...
    <section id="workshops">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                  ...
                                  <center><input type="button" id="onclick" value="Register">
                                  </center>
        ...
        <div id="contactdiv" style="display: none;">
			 ...
			 <!--form name="sentMessage1" action="registerprocess1.php" class="form"   method="POST" id="contact" id="contactForm" novalidate>
			 <img src="button_cancel.png" class="img" id="cancel">
					<h3>Register Here!</h3><hr>
                        <div class="row"><center>
                            <div >
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Your Name *" id="name1" required data-validation-required-message="Please enter your name." style="width: 200px;">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" placeholder="Your Email *" id="email1" required data-validation-required-message="Please enter your email address." style="width: 200px;">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="phone" class="form-control" placeholder="Your Phone *" id="phone1" required data-validation-required-message="Please enter your phone number." style="width: 200px;">
                                    <p class="help-block text-danger"></p>
                                </div>
                            
                                <div class="form-group">
                                    <input type="text" name="college" class="form-control" placeholder="Your College *" id="message1" required data-validation-required-message="Please enter a message." style="width: 200px;">
                                    <p class="help-block text-danger"></p>
                                </div>
								<div class="form-group">
 <label for="productTypeTC" style="white-space: nowrap;"><input type="radio" id="rad" name="payment"  value="Online"/> Online</label><br>
   <label for="productTypeTC" style="white-space: nowrap;"><input type="radio" id="rad" name="payment" value="Demand Draft" /> DD</label><br>
  <label for="productTypeTC" style="white-space: nowrap;"><input type="radio" id="rad" name="payment" value="cash" />Cash</label>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>	
			...
			<form action="registerprocess1.php" class="form"   id="contact" method="POST">
                <img src="button_cancel.png" class="img" id="cancel">   
                <h3>Register Here!</h3>
                <hr>
                ...
                <br>
                <input type="text"  name="phone" placeholder="10 digit Mobile no."><br>
				<label>College: <span>*</span></label>
                <br>
                <input type="text"  name="college" placeholder="Your College "><br>
  ...
  <label for="productTypeTC" style="white-space: nowrap;"><input type="radio" id="rad" name="payment" value="cash" />Cash</label>
			   ...
			   <!--
				...
				<input type="checkbox" value="online" checked>Pay Onlinet<br>
				<input type="checkbox" value="cash">Pay by Cash<br>
				<input type="checkbox" value="dd">Pay by Demand Draft<br -->
...
<!-- Bharathi Copy from Section -->
	...
	<section id="events" ng-controller="EventsController">
        <div class="container">
            ...
            <div id="Container">
                <a href="" data-toggle="modal" data-target="#myModal{{event.modelNo}}" ng-repeat="event in events">
                    <div class="col-lg-4 mix ssn-shadow category-{{event.category}}" >
                        <div class="thumbnail">
...
<div class="modal fade" id="myModal{{event.modelNo}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" ng-repeat="event in events">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">
						<img ng-src="{{event.imageurl}}" class="img-responsive" alt="..." width="550" height="100">
						</h4>
                    </div>
                    <div class="modal-body">
					<center><b>{{event.name}}</b> </center>   
					<p>{{event.desc}}</p>
					<center><b>contact</b></center>
					<center><p>{{event.contact}}</p></center>
...
<!-- Bharathi Copy till this Section -->
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                       <a href="http://www.zoho.com" target="_new"> <img src="img/zoho1.jpg" class="img-responsive img-circle" alt=""></a>
                        <h4>ZOHO</h4>
...
Focus on what really matters, while our apps do everything you need.</p>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                      <a href="http://linkstreet.in" target="_new"> <img src="img/street.jpg" class="img-responsive img-circle" alt=""></a>
                        <h4>Linkstreet</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <a href="http://www.studiossingularity.com" target="_new"><img src="img/singularity.jpg" class="img-responsive img-circle" alt=""></a>
...
Where the impossible becomes the inevitable</p>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                       <a href="http://globalsinc.com" target="_new"> <img src="img/globalinc.jpg" class="img-responsive img-circle" alt=""></a>
                        <h4>Globals Inc.</h4>
...
<section   class="bg-striped">
	...
	<div class="row">
			...
			<?php
                        ...
                        if (isset($_SESSION['user_id'])) {
                            ...
                            echo "<a href='login.php'><img src='login_1.png' width='200' height='135' alt='Sign in with Facebook'/></a>";
                        }
                    ?>
		</div>
	</div>
	
	<h3 class="section-subheading">OR</h3>
	<br>
	<br>
	
	<div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" action="registerprocess.php" id="contactForm" novalidate>
                        <div class="row">
                            <div >
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Your Name *" id="name" required data-validation-required-message="Please enter your name." style="width: 200px;" required>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" placeholder="Your Email *" id="email" required data-validation-required-message="Please enter your email address." style="width: 200px;" required>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="phone" class="form-control" placeholder="Your Phone *" id="phone" required data-validation-required-message="Please enter your phone number." style="width: 200px;" required>
                                    <p class="help-block text-danger"></p>
                                </div>
                            
                                <div class="form-group">
                                    <input type="text" name="college" class="form-control" placeholder="Your College *" id="message" required data-validation-required-message="Please enter a message." style="width: 200px;" required>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>	
                            <div class="clearfix"></div>
	...
	<div class="row">
        ...
        <div class="row">
            <div class="col-lg-6 text-center" id="contact1">
                <h4 class="section-heading">Narayanan U</h4>
                <h5 class="section-subheading text-muted">Chairman, ITA</h5>
                <h5 class="section-subheading text-muted">+91-9489002732</h5>
                <h5 class="section-subheading text-muted">chairmanita@mitindia.edu</h5>
